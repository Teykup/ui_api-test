...
public class BrandsListDTOTests {
    ...
    @BeforeAll
    static void setup(){
        getResponse = ConnectionManager.getResponse(ConnectionManager.Method.GET, urlEndpoint);
        putResponse = ConnectionManager.getResponse(ConnectionManager.Method.PUT, urlEndpoint);
