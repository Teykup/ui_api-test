...
public class UserAccountDTOTests {
    ...
    void testPostToCreateAccountWithValidData() {
        ...
        userAccountDTO = Injector.deserialize(userAccountDTO, ConnectionManager.Method.POST, userData, createAccountEndpoint);
    ...
    void testRetrievingUserData() {
        ...
        UserAccountDTO userCredentials = Injector.deserialize(new UserAccountDTO(), ConnectionManager.Method.GET, params, "getUserDetailByEmail");
    ...
    void testPutToUpdateAccountWithValidData() {
        ...
        userAccountDTO = Injector.deserialize(userAccountDTO, ConnectionManager.Method.PUT, userData, updateAccountEndpoint);
    ...
    void testDeletingUser() {
        ...
        UserAccountDTO productListDTO = Injector.deserialize(new UserAccountDTO(), ConnectionManager.Method.DELETE, params, "deleteAccount");
